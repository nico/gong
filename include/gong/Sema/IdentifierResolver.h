...
#ifndef LLVM_GONG_AST_SEMA_IDENTIFIERRESOLVER_H
#define LLVM_GONG_AST_SEMA_IDENTIFIERRESOLVER_H
...
public:
  ...
  iterator begin(IdentifierInfo &Name);
  ...
  bool tryAddTopLevelDecl(NamedDecl *D, IdentifierInfo &Name);
