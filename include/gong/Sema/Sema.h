...
#include "gong/AST/NSAPI.h"
#include "gong/AST/PrettyPrinter.h"
#include "gong/AST/TypeLoc.h"
#include "gong/Basic/ExpressionTraits.h"
...
public:
  ...
  /// '\#pragma gong arc_cf_code_audited' and, if so, consider adding
