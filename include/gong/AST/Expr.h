...
public:
  ...
  /// the part of the C++ committee.  In gong, when we say "r-value",
...
public:
  typedef gong::CastKind CastKind;
...
/// ShuffleVectorExpr - gong-specific builtin-in function
...
public:
  ...
  ///
  /// @todo This class is infuriatingly similar to gong::Designator,
...
/// AsTypeExpr - gong builtin function __builtin_astype [OpenCL 6.2.4.2]
...
#include "gong/Basic/Builtins.def"
