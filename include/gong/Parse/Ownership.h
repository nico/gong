...
#ifndef LLVM_GONG_PARSE_OWNERSHIP_H
#define LLVM_GONG_PARSE_OWNERSHIP_H
...
namespace llvm {
  ...
  public:
    ...
    static inline gong::OpaquePtr<UID> getFromVoidPointer(void *P) {
      return gong::OpaquePtr<UID>::make(P);
    }
