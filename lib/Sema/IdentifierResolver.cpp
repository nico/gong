...
//#include "gong/Lex/ExternalPreprocessorSource.h"
...
public:
  ...
  IdDeclInfo &operator[](IdentifierInfo &Name);
};
...
void IdentifierResolver::AddDecl(NamedDecl *D) {
  IdentifierInfo& Name = D->getDeclName();
  updatingIdentifier(Name);
...
bool IdentifierResolver::ReplaceDecl(NamedDecl *Old, NamedDecl *New) {
  ...
  IdentifierInfo &Name = Old->getDeclName();
  updatingIdentifier(Name);
...
IdentifierResolver::begin(IdentifierInfo &Name) {
  readingIdentifier(Name);
...
bool IdentifierResolver::tryAddTopLevelDecl(NamedDecl *D, IdentifierInfo &Name){
  readingIdentifier(Name);
...
IdentifierResolver::IdDeclInfoMap::operator[](IdentifierInfo &Name) {
  void *Ptr = Name.getFETokenInfo<void>();
